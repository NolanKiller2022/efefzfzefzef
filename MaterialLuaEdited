...
local Themes = {
	...
	Nebulous = {
		MainFrame = Color3.fromRGB(69, 123, 157),
		Minimise = Color3.fromRGB(250, 163, 17),
		MinimiseAccent = Color3.fromRGB(250, 163, 17),
		Maximise = Color3.fromRGB(230, 57, 70),
		MaximiseAccent = Color3.fromRGB(230, 57, 70),
		NavBar = Color3.fromRGB(70, 123, 157),
		NavBarAccent = Color3.fromRGB(255, 255, 255),
		NavBarInvert = Color3.fromRGB(255, 255, 255),
		TitleBar = Color3.fromRGB(69, 123, 157),
		TitleBarAccent = Color3.fromRGB(255, 255, 255),
		Overlay = Color3.fromRGB(250, 163, 17),
		Banner = Color3.fromRGB(245, 199, 67),
		BannerAccent = Color3.fromRGB(230, 57, 70),
		Content = Color3.fromRGB(245, 199, 67),
		Button = Color3.fromRGB(70, 123, 157),
		ButtonAccent = Color3.fromRGB(255, 255, 255),
		ChipSet = Color3.fromRGB(70, 123, 157),
		ChipSetAccent = Color3.fromRGB(255, 255, 255),
		DataTable = Color3.fromRGB(245, 199, 67),
		DataTableAccent = Color3.fromRGB(255, 255, 255),
		Slider = Color3.fromRGB(245, 199, 67),
		SliderAccent = Color3.fromRGB(230, 57, 70),
		Toggle = Color3.fromRGB(250, 163, 17),
		ToggleAccent = Color3.fromRGB(255, 255, 255),
		Dropdown = Color3.fromRGB(245, 199, 67),
		DropdownAccent = Color3.fromRGB(230, 57, 70),
		ColorPicker = Color3.fromRGB(245, 199, 67),
		ColorPickerAccent = Color3.fromRGB(230, 57, 70),
		TextField = Color3.fromRGB(255, 255, 255),
		TextFieldAccent = Color3.fromRGB(70, 123, 157)
        }
}
